...
kb:
	...
	@curl https://raw.githubusercontent.com/egonw/jcheminform-kb/main/volume_4.ttl  -o volume_4.ttl
	@curl https://raw.githubusercontent.com/egonw/jcheminform-kb/main/volume_11.ttl  -o volume_11.ttl
...
doilist.txt: kb
	...
	@roqet -q queries/allPaper.rq -D volume_4.ttl -r csv | grep -v "doi" | tee -a doilist.txt
